...
import com.slavi.statistics.Helmert2DTransformLearner;
import com.slavi.statistics.Helmert2DTransformer;
...
public class Helmert2DTransformerTest {
	...
	public static void main(String[] args) {
		Helmert2DTransformerTest test = new Helmert2DTransformerTest();
		test.generatePoints();
		test.learn();
