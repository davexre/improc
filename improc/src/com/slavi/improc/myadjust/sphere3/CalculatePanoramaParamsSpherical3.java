...
public class CalculatePanoramaParamsSpherical3 implements Callable<ArrayList<ArrayList<KeyPointPairList>>> {
	...
	public CalculatePanoramaParamsSpherical3(ExecutorService exec,
			ArrayList<KeyPointPairList> kppl,
			AbsoluteToRelativePathMaker keyPointPairFileRoot,
			String outputDir,
			boolean pinPoints,
	...
	private class ProcessOne implements Callable<Void> {
		...
		public Void call() {
			copyBadStatus(chain);
			SpherePanoTransformLearner3 learner = new SpherePanoTransformLearner3(chain);
