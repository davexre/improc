...
public class CalculatePanoramaParamsSpherical implements Callable<ArrayList<ArrayList<KeyPointPairList>>> {
	...
	public CalculatePanoramaParamsSpherical(ExecutorService exec,
			ArrayList<KeyPointPairList> kppl,
			AbsoluteToRelativePathMaker keyPointPairFileRoot,
			String outputDir,
			boolean pinPoints,
