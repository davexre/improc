...
public class CalculatePanoramaParamsZYZ implements Callable<ArrayList<ArrayList<KeyPointPairList>>> {
	...
	public CalculatePanoramaParamsZYZ(ExecutorService exec,
			ArrayList<KeyPointPairList> kppl,
			AbsoluteToRelativePathMaker keyPointPairFileRoot,
			String outputDir,
			boolean pinPoints,
	...
	private class ProcessOne implements Callable<Void> {
		...
		public Void call() {
			copyBadStatus(chain);
			MyPanoPairTransformZYZLearner learner = new MyPanoPairTransformZYZLearner(chain);
