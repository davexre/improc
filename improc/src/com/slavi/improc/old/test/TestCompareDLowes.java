...
import com.slavi.improc.old.singletreaded.DGaussianFilter;
...
public class TestCompareDLowes {
	...
	public static void compareApplyFilters() throws Exception {
		DImageMap img = new DImageMap(new File(srcImg));
		DImageMap blur1 = new DImageMap(img.getSizeX(), img.getSizeY());
		DImageMap blur2 = new DImageMap(img.getSizeX(), img.getSizeY());
		DGaussianFilter gf = new DGaussianFilter();
...
//			Test.compareBImages(fn1, fn2);
			TestCompareDLowes.compareFiles(workDir + "debug.my", workDir + "debug.s.my");
