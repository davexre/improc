...
public class CustomPolynomialTransformer extends BaseTransformer {
	...
	private CustomPolynomialTransformer() {
	}
	
	public CustomPolynomialTransformer(int polynomPower, int inputSize, int outputSize) {
	...
	public static CustomPolynomialTransformer fromXML(Element source) throws JDOMException {
		CustomPolynomialTransformer r = new CustomPolynomialTransformer();
	...
	public static int getVectorSize(int numVariables, int polynomPower) {
		double result = Math.pow(polynomPower + 1, numVariables);
		if (numVariables > 1)
	...
	public static void main(String[] args) {
		System.out.println(getVectorSize(2,2));
	}
