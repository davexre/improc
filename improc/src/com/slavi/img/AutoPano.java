...
public class AutoPano {
	...
	public KeyPointPairList pointPairs;
...
// TODO:	pointPairs.addPair(ap, (KeyPoint)nnlst.getItem(0), nnlst.getDistanceToTarget(0), nnlst.getDistanceToTarget(1));
			fou.println(
...
// TODO:		fou.println("i w" + pointPairs.targetImageSizeX + " h" + pointPairs.targetImageSizeY + " f0 a0 b0 c0 d0 e0 g0 p0 r0 t0 v38 y0 u10 n\"" + pointPairs.targetImageFileName + "\"");
// TODO:		fou.println("i w" + pointPairs.sourceImageSizeX + " h" + pointPairs.sourceImageSizeY + " f0 a0 b0 c0 d0 e0 g0 p0 r0 t0 v38 y0 u10 n\"" + pointPairs.sourceImageFileName + "\"");
...
// TODO:		autoPano.pointPairs = new KeyPointPairList(spl1, spl2);
...
// TODO:		autoPano.pointPairs = KeyPointPairList.fromXML(e);
				...
				Marker.release();
				autoPano.pointPairs.sortByDiscrepancy();
