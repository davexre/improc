...
public abstract class BaseTransformer<InputType, OutputType> {
	...
	public abstract double setSourceCoord(InputType item, int coordIndex, double value);

	public abstract double getTargetCoord(OutputType item, int coordIndex);
	
	public abstract double setTargetCoord(OutputType item, int coordIndex, double value);
	 ...
	 */
	public void transformExtent(InputType source, OutputType dest) {
		if ((getInputSize() != 2) || (getOutputSize() != 2))
