...
public class DLoweCompareResult {
	...
	static KeyPointList makeWithOldDetector(String fileName) throws IOException {
	...
	static KeyPointList makeWithNewDetector(String fileName) throws IOException  {
...
//						return false; // Found a second one
	...
	static void doIt(String fileName) throws IOException {
		...
		Marker.mark();
		KeyPointList kp2 = makeWithOldDetector(fileName);
		Marker.release();
