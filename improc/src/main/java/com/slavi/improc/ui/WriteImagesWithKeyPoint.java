...
public class WriteImagesWithKeyPoint implements Callable<Void> {
	...
	public Void call() throws Exception {
		class WriteImage implements Callable {
			KeyPointList l;
		...
		TaskSetExecutor ts = new TaskSetExecutor(exec) {
			int counter = 0;
			public synchronized void onTaskFinished(Object task, Object result) throws Exception {
				SwtUtil.activeWaitDialogSetStatus("Writing images...", ++counter);
			}
		};
