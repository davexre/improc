...
public class MyMnistDataTest {
	void doIt() throws Exception {
		Marker.mark("Read");
//		List<? extends DatapointPair> trainset = MnistData.readDataSet(false).subList(0, 1000); // Number 8 is missing until index 61,84, 110
...
//				.addFullyConnectedLayer(output0.getVectorSize())
				//.addSigmoidLayer()
