...
/*
 * One light pen
 * No adjustment of alpha & beta
 */
public class Printer3DAdjust5_1 {
	...
	public static class Data {
		...
		ArrayList<Measurement> measurements = new ArrayList<Printer3DAdjust5_1.Measurement>();
	}
	...
	void adjust() {
		...
		LeastSquaresAdjust lsa = new LeastSquaresAdjust(6);
		lsa.clear();
...
*/		
		...
		adjOffsetX += U.getItem(0, 4);
		adjOffsetY += U.getItem(0, 5);
